  ...
  return (
    <div className=" mb-10">
      ...
      <div className="bg-[#FED7CF] pt-10 text-center">
        ...
        <div></div>
        <div className="text-4xl  text-center text-[#6A302F] mt-4 ">
        ...
        <div className="h-[350px]">
          ...
          <img src="kalash 1.svg" className="absolute w-60 mt-20 left-[45%] z-50" />
        ...
        <div className="flex pt-20 flex-col items-center justify-center mt-10 rounded-t-[931px] bg-gradient-to-b from-[#FFF] to-[#FCF2E7] w-full">
          ...
          <div className="text-sm mt-4">Join us in this extraordinary journey and witness the confluence of tradition, devotion, and enlightenment.</div>
          <button className="bg-[#6A302F] w-60 mt-4 text-sm text-white text-center px-4 py-2 rounded-xl">
          Explore our service offerings
          </button>

          <div className="mt-20">
            <div className="uppercase text-4xl text-[#6A302F]  underline">How to reach?</div>
            <div className="mt-4 text-sm">Prayagraj city is well connected to all major Cities in India via the Indian <br/> Railways network, Highways and Prayagraj Airport located in Bamrauli.</div>
          </div>

          <div className="mt-10">
            <div className="uppercase text-4xl text-[#6A302F]  underline">Tourist guide</div>
            <div className="mt-4 text-sm">The Tourism Department Uttar Pradesh has introduced 4 walks<br/> showcasing the various aspects of Prayagraj heritage.</div>
          </div>

          <div className="mt-10">
            <div className="uppercase text-4xl text-[#6A302F]  underline">where to stay?</div>
            <div className="mt-4 text-sm">Tent city, hotels, public accommodations and home stay- Prayagraj <br/> Mahakumbh 2025 offers all types stays for you and your family.</div>
          </div>
